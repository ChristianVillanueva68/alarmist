    ...
    <form action="" id="post-form">
        ...
        <div class="form-group mb-3">
            ...
            <div id="upload-images" class="mt-4">
                <h4 class="font-weight-bolder" id="upload-text"rq>Add your Photos Here</h4>
                ...
                <button id='select-upload' class='btn btn-primary rounded-0' type='button'>Upload Photos Here</button>
                <input type="file" name="img[]" class="d-none" required="required">
            </div>
        </div>
    </form>
</div>
