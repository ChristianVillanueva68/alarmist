...
<style>
    ...
    .post-holder {
        width: 100%;
        padding-top: 100%; /* Maintain 1:1 aspect ratio for post images */
        position: relative;
        overflow: hidden;
    }
...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-light shadow blur d-flex w-100 justify-content-center align-items-center flex-column">
    ...
    <div class="profile-info">
        <h3 class="text-center profile-name"><?= isset($name) ? $name : '' ?></h3>
        <div class="text-center profile-email"><?= isset($email) ? $email : '' ?></div>
    </div>
</div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <a href="./?page=posts/view_post&id=<?= $row['id'] ?>" class="card rounded-0 shadow col-lg-4 col-md-6 col-sm-12 col-xs-12 post-item px-0 text-decoration-none text-reset">
                            ...
                            <div class="card-body">
                                <div class="post-info">
                                    <div class="post-likes"><i class="far fa-heart"></i> <?= format_num($row['likes']) ?></div>
                                    <div class="post-comments"><i class="far fa-comment"></i> <?= format_num($row['comments']) ?></div>
                                </div>
                            </div>
                        </a>
                        <?php endwhile; ?>
